(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-texts")) {
            new core(".slider-texts", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".columnslider__slider")) {
            new core(".columnslider__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".photo__slider_1")) new core(".photo__slider_1", {
        ...
        if (document.querySelector(".photo__slider_2")) new core(".photo__slider_2", {
            modules: [ Navigation, Pagination, Scrollbar, freeMode, Mousewheel ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".swiper-arrow_next",
                nextEl: ".swiper-arrow_prev"
            },
            on: {}
        });
        if (document.querySelector(".slider-map__slider")) {
            let mySwiper = new core(".slider-map__slider", {
                modules: [ Navigation, Pagination, Scrollbar, freeMode, Mousewheel ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const dom = {
            progress: {
                ...
                questionNumber: document.getElementById("quastion-number"),
                totalQuastions: document.getElementById("total-quastions")
            },
            next: document.getElementById("next"),
            prev: document.getElementById("prev")
        };
        document.querySelector(".quiz");
        const form = document.querySelector(".dynamic-content");
        const formItems = document.querySelectorAll("fieldset");
        const btnsNext = document.querySelectorAll(".content-quiz__button-next");
        const btnsPrev = document.querySelectorAll(".content-quiz__button-prev");
        const answersObj = {
            step0: {
                question: "",
                answers: []
        ...
        let totalSteps = Object.keys(answersObj).length - 1;
        let step = 1;
        function renderProgress(total, step) {
            const progressPercent = 100 / total * step;
            dom.progress.questionNumber.innerHTML = Math.round(progressPercent);
        ...
        formItems.forEach(((formItem, formItemIndex) => {
            if (0 === formItemIndex) formItem.style.display = "block"; else formItem.style.display = "none";
            if (formItemIndex !== formItems.length - 1) {
                const itemTitle = formItem.querySelector(".dynamic-content__header");
            ...
            formItem.addEventListener("change", (e => {
                ...
                if (formItemIndex !== formItems.length - 1) {
                    answersObj[`step${formItemIndex}`].answers.lengh = 0;
                    inputsChecked.forEach((inputChecked => {
                        answersObj[`step${formItemIndex}`].answers.push(inputChecked.value);
                    }));
                    if (inputsChecked.length > 0) btnsNext[formItemIndex].disabled = false; else btnsNext[formItemIndex].disabled = true;
                    if (target.classList.contains("check__input")) {
                        const radios = formItem.querySelectorAll(".check__input");
                        radios.forEach((input => {
                            if (input === target) input.parentNode.classList.add("active-radio"); else input.parentNode.classList.remove("active-radio");
                        }));
                    } else if (target.classList.contains("checkbox__input")) target.parentNode.classList.toggle("active-checkbox"); else return;
                }
            }));
        }));
        const sendForm = body => {
            ...
            form.addEventListener("submit", (e => {
                e.preventDefault();
                console.log(document.getElementById("quiz-phone"));
                answersObj.step9.phone = document.getElementById("quiz-phone").value;
                answersObj.step9.messengers = document.getElementById("quiz-messengers").value;
                answersObj.step9.messengers = document.querySelector(".quiz-last__socials").value;
    ...
    new Typed(".typing-text", {
        strings: [ "Устанавливаем", "Проектируем", "Рисуем", "Доставляем", "Производим" ],
        typeSpeed: 90,
        loop: true
    });
    ...
    realFileBtn.addEventListener("change", (function() {
        if (realFileBtn.value) customTxt.innerHTML = realFileBtn.value.match(/[\/\\]([\w\d\s\.\-\(\)]+)$/)[1]; else customTxt.innerHTML = "No file chosen, yet.";
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
